...
PieceManager::PieceManager(const uint32_t piece_size) : piece_size_(piece_size)
{
  initialize_pieces();
}
...
void PieceManager::initialize_pieces()
{
  pieces_.reserve(32);
  
  // Construct black army
  pieces_.push_back(new Rook(glm::vec2(0, 0), glm::vec2(piece_size_), Color::BLACK,
                             ResourceManager::get_texture("black_rook")));
  pieces_.push_back(new Knight(glm::vec2(100, 0), glm::vec2(piece_size_), Color::BLACK,
                               ResourceManager::get_texture("black_knight")));
  pieces_.push_back(new Bishop(glm::vec2(200, 0), glm::vec2(piece_size_), Color::BLACK,
                               ResourceManager::get_texture("black_bishop")));
  pieces_.push_back(new Queen(glm::vec2(300, 0), glm::vec2(piece_size_), Color::BLACK,
                              ResourceManager::get_texture("black_queen")));
  pieces_.push_back(new King(glm::vec2(400, 0), glm::vec2(piece_size_), Color::BLACK,
                             ResourceManager::get_texture("black_king")));
  pieces_.push_back(new Bishop(glm::vec2(500, 0), glm::vec2(piece_size_), Color::BLACK,
                               ResourceManager::get_texture("black_bishop")));
  pieces_.push_back(new Knight(glm::vec2(600, 0), glm::vec2(piece_size_), Color::BLACK,
                               ResourceManager::get_texture("black_knight")));
  pieces_.push_back(new Rook(glm::vec2(700, 0), glm::vec2(piece_size_), Color::BLACK,
                             ResourceManager::get_texture("black_rook")));
  
  // Construct black pawns
  for (uint32_t i = 0; i < 8; i++)
  {
    pieces_.push_back(new Pawn(glm::vec2(i*100, 100), glm::vec2(piece_size_), Color::BLACK,
  ...
  for (uint32_t i = 0; i < 8; i++)
  {
    pieces_.push_back(new Pawn(glm::vec2(i*100, 600), glm::vec2(piece_size_), Color::WHITE,
                               ResourceManager::get_texture("white_pawn")));
  }
  
  // Construct white army
  pieces_.push_back(new Rook(glm::vec2(0, 700), glm::vec2(piece_size_), Color::WHITE,
                             ResourceManager::get_texture("white_rook")));
  pieces_.push_back(new Knight(glm::vec2(100, 700), glm::vec2(piece_size_), Color::WHITE,
                               ResourceManager::get_texture("white_knight")));
  pieces_.push_back(new Bishop(glm::vec2(200, 700), glm::vec2(piece_size_), Color::WHITE,
                               ResourceManager::get_texture("white_bishop")));
  pieces_.push_back(new Queen(glm::vec2(300, 700), glm::vec2(piece_size_), Color::WHITE,
                              ResourceManager::get_texture("white_queen")));
  pieces_.push_back(new King(glm::vec2(400, 700), glm::vec2(piece_size_), Color::WHITE,
                             ResourceManager::get_texture("white_king")));
  pieces_.push_back(new Bishop(glm::vec2(500, 700), glm::vec2(piece_size_), Color::WHITE,
                               ResourceManager::get_texture("white_bishop")));
  pieces_.push_back(new Knight(glm::vec2(600, 700), glm::vec2(piece_size_), Color::WHITE,
                               ResourceManager::get_texture("white_knight")));
  pieces_.push_back(new Rook(glm::vec2(700, 700), glm::vec2(piece_size_), Color::WHITE,
                             ResourceManager::get_texture("white_rook")));
}
...
void PieceManager::reset_pieces()
{
  wipe_pieces();
  initialize_pieces();
}
